...
pub fn heliocentric_pos(body: SolarSystem, time: &AstroTime) -> SKResult<Vec3> {
    ...
    let (a, eccen, incl, l, wbar, Omega, terms) = {
        if time > &tmp0 && time < &tmp1 {
            ...
            let a: [f64;6] = match body {
                SolarSystem::Mercury => [0.38709843, 0.20563661, 7.00559432, 252.25166724, 77.45771895, 48.33961819],
                SolarSystem::Venus => [0.72332982, 0.00677192, 3.39777545, 181.97970850, 131.76755713, 76.67261496],
                SolarSystem::EMB => [1.000001018, 0.01670863, -0.00004180, 100.46457166, 102.93768193, 0.0],
                SolarSystem::Mars => [1.52367934, 0.09340065, 1.85181869, -4.56813164, -23.91744784, 49.71320984],
                SolarSystem::Jupiter => [5.202603191, 0.048464512, 1.298470324, 34.33479152, 14.27495244, 100.29282654],
                SolarSystem::Saturn => [9.554909596, 0.05550825, 2.49424102, 50.07571329, 92.86136063, 113.63998702],
                SolarSystem::Uranus => [19.218446062, 0.04629590, 0.77237271, 314.20276625, 172.43404441, 73.96250215],
                SolarSystem::Neptune => [30.110386869, 0.00898809, 1.77004347, -55.12002969, 44.96476227, 131.78422574],
                _ => return Err("Invalid Body".into()),
            };
            let adot: [f64;6] = match body {
                SolarSystem::Mercury => [0.00000000, 0.00002123, -0.00590158, 149472.67486623, 0.15940013, -0.12214182],
                SolarSystem::Venus => [-0.00000026, -0.00005107, 0.00043494, 58517.81560260, 0.00682069, -0.23431738],
                SolarSystem::EMB => [-0.0000003, -0.00003661, -0.01337178, 35999.37306329, 0.31795260, -0.24123856],
                SolarSystem::Mars => [0.00000097, 0.00009149, -0.00724757, 19140.29934243, 0.45223625, -0.26852431],
                SolarSystem::Jupiter => [-0.00002864, 0.00018026, -0.00322699, 3034.90371757, 0.18199196, 0.13024619],
                SolarSystem::Saturn => [-0.00003065, -0.00032044, 0.00451969, 1222.11494724, 0.54179478, -0.25015002],
                SolarSystem::Uranus => [-0.00020455, -0.00001550, -0.00180155, 428.49512595, 0.09266985, 0.05739699],
                SolarSystem::Neptune => [0.00006447, 0.00000818, 0.00022400, 218.46515314, 0.01009938, -0.00606302],
                _ => return Err("Invalid Body".into()),
            };
