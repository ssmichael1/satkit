...
/// Take the difference between two Instant time instances
...
impl Instant {
    #[inline]
    /// Construct new Instant object,
    /// representing time at TAI epoch of modified Julian date
    pub fn new() -> Instant {
        Instant { mjd_tai: JD2MJD }
    }

    /// Construct new Instant object, representing given unixtime
    ...
    /// Construt new Instant object, representing
    ...
    /// Construct new Instant object representing time at
    ...
    /// Construct Instant object from given UTC Gregorian Date
    ///
    /// # Arguments
    ///
    /// * `year` - the year
    ...
    /// Convert Instant to UTC Gregorian date
    ///
    /// # Returns
    ///
    ...
    /// Convert Instant to Gregorian date and timewith given scale
    ///
    /// # Arguments
    ///
    ...
    /// Convert Instant to UTC Gregorian date and time
    ///
    /// # Returns
    ///
    /// * 6-element tuple with following values:
    ...
    /// Convert UTC Gregorian date and time to Instant
    ///
    /// # Arguments
    ///
    /// * `year` - the year (u32)
