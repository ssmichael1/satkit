...
//! | **refreshed** | Earth orientation (`finals2000A.all`, IERS), space weather (GFZ Potsdam observed record, NOAA/SWPC 45-day and NASA MSAFE monthly forecasts) | change daily; fetched by `update_datafiles()` or on first use |
//!
//! # Precedence
//!
...
//! be resolved at all). Using an embedded copy is silent: it is the normal
