...
/// shown at most once per process; this suppresses all of them. They are
/// logged to the ``satkit.spaceweather`` logger; silencing that logger (or
/// ``satkit``) with :mod:`logging` works too.
///
/// Example:
