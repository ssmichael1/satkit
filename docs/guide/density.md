...
- $C_d$ : Coefficient of Drag. This is a function of the material properties of the satellite, and is generally in the range [1,3].
- $A$ : Area of satellite normal to the drag force
- $m$ : Mass of satellite
- $\rho$ : Air Density
...
![Air Density vs solar cycle](../images/density_vs_solar_cycle.svg)
