...
| `SATKIT_QUIET=1` | suppress the warnings about a corrupt or unreadable IERS table in a search directory being replaced by the compiled-in copy, and about a gravity file whose declared tide system contradicts its C20 (other warnings: see [Warnings and logging](troubleshooting.md#warnings-and-logging-how-do-i-silence-or-redirect-these-warnings)) |
